...
class CockpitTest {
    ...
    public void supprimerEntiteTest(){
        ...
        assertEquals(5,supprimerEntite(listeEntite,True,True2, sailor,moving).size());
        assertEquals(5, supprimerEntite(listeEntite,True,True2, sailor,moving).size());
        assertEquals(5, supprimerEntite(listeEntite,True3,True2, sailor,moving).size());
        ArrayList<Entity> listeNulle = new ArrayList<>();
        assertEquals(0, supprimerEntite(listeNulle,True3,True2, sailor,moving).size());
    }
